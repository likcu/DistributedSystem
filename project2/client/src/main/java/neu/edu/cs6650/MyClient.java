...
//    timer.scheduleAtFixedRate(new PeriodCount(request, timestamp, list), 0, 1000);
    ...
    System.out.println("Overall throughput across all phases:" + String.format("%.01f",measure.requests.get() / walltime));
    ...
    System.out.println("Successful requests:" + measure.sucRequests.get());
...
//      args[1] = "localhost:8080/";
      args[1] = "http://localhost:8080/";
      //args[1] = "http://123-1994540205.us-west-1.elb.amazonaws.com:8080/";
      //args[1] = "http://ec2-54-193-95-40.us-west-1.compute.amazonaws.com:8080/";
      args[2] = "1";
      args[3] = "10000";
      args[4] = "100";
    }
